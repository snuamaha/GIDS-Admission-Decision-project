...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Outputs recommended admission decisions given reviewers' feedback")
    parser.add_argument("-d", 
                        help='enter the path to the reviewer feedback spreadsheets')
